...
function SignUp() {
  ...
  useEffect(() => {
    document.title = "Sign up | PLM";
  }, []);
  
  useEffect(() => {
    setFormValid(username.trim() !== "" && adminkey.trim() !== "" &&  password.trim()!=="" && confirmPassword.trim() !=="" );
  }, [username, adminkey , password , confirmPassword ]);
      ...
      <div className="border-2 p-10 shadow-xl rounded-md">
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
          <div>
            ...
            />
      {/* admin Key */}
      <label htmlFor="username">admin key</label>
            <input
              type="text"
              name="admin key"
          ...
          <button
  type="submit"
  className={`px-8 py-1 mt-2 rounded border-2 border-purple-600 text-purple-600 duration-300 ${
